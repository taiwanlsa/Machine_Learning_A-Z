import os  #工作路徑用
os.chdir("D:\Machine Learning A-Z Chinese Template Folder\Part 9 - Dimensionality Reduction\Section 36 - Principal Component Analysis (PCA)");
#自動跳到工作路徑
