import os  #工作路徑用
os.chdir("D:\Machine Learning A-Z Chinese Template Folder\Part 10 - Model Selection & Boosting\Section 40 - Model Selection");
#自動跳到工作路徑
#邏輯迴歸處理程式集
...
os.chdir("D:\Machine Learning A-Z Chinese Template Folder\Part 3 - Classification\Section 12 - Kernel SVM");
#自動跳到工作路徑
...
accrracies = cross_val_score(estimator = classifier ,  X= X_train , y= Y_train, cv = 10)
#交叉驗證
accrracies.mean() #取平均值
